---
{"dg-publish":true,"permalink":"/knowledge/02-tech-second-brain/ai-core/nlp/lo-ra-cho-continual-learning-o-lo-ra-n-lo-ra-mo-la-slim/","pinned":"false","tags":["type/paper","topic/peft-lora","topic/continual-learning","topic/legal-ai","status/stable"]}
---


# LoRA cho Continual Learning — O-LoRA, N-LoRA, MoLA, SLIM
...
> - [Playbook chỉnh tham số và sweep](LoRA - Playbook chỉnh tham số và sweep.md) — *làm sao dò ra giá trị tối ưu*
> - **LoRA cho Continual Learning** (đang đọc) — *nhiều task nối tiếp thì tổ chức adapter thế nào*
>
> Gộp ngày 2026-08-06 từ bốn note cũ vốn chồng nội dung nhau.

Nền tảng regularization/constraint và cách triển khai thực tế.
...
## Phụ lục: chọn rank cho từng task trong continual learning

### r cho mỗi nhiệm vụ hoặc domain
...
### Kết nối với pipeline legal (CPT vs SFT vs CL)
