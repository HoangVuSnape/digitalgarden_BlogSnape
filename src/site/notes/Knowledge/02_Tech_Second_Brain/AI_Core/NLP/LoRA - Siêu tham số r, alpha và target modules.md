---
{"dg-publish":true,"permalink":"/knowledge/02-tech-second-brain/ai-core/nlp/lo-ra-sieu-tham-so-r-alpha-va-target-modules/","pinned":"false","tags":["type/paper","topic/peft-lora","topic/fine-tune","topic/llm","status/stable"]}
---


# LoRA — Siêu tham số r, alpha và target modules

> **Bộ ba note về LoRA.** Ba note dưới đây tách theo câu hỏi mà chúng trả lời:
>
> - **Siêu tham số r, alpha và target modules** (đang đọc) — *các tham số nghĩa là gì, nên đặt bao nhiêu*
...
### r trong bài "LoRA Learns Less and Forgets Less" (CPT)
...
### r trong Unsloth (SFT) — tại sao lại nhỏ?
