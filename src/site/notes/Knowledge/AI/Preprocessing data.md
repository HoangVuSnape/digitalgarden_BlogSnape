---
{"dg-publish":true,"permalink":"/knowledge/ai/preprocessing-data/","title":"Preprocessing data","pinned":"false","tags":["#NCKH","AI"]}
---

- Ở đây là những ý tưởng để mình xử lý preprocessing data

# Histogram
![](/img/user/assets/images/Knowledge/AI/IMG-20251018180049251.png)
Ta có nhận xét: 
...
![](/img/user/assets/images/Knowledge/ComputerVision/NCKH/IMG-20251018180049429.png)
![](/img/user/assets/images/Knowledge/AI/IMG-20251018180049707.png)
![](/img/user/assets/images/Knowledge/AI/IMG-20251018180050181.png)

# Phóng to ảnh 
- ![](/img/user/assets/images/Knowledge/AI/IMG-20251018180050499.png)
![](/img/user/assets/images/Knowledge/AI/IMG-20251018180050850.png)

# CLAHE
![](/img/user/assets/images/Knowledge/AI/IMG-20251018180051233.png)

![](/img/user/assets/images/Knowledge/ComputerVision/NCKH/IMG-20251018180051296.png)

# Data augmentation
- diffusion model

![](/img/user/assets/images/Knowledge/AI/IMG-20251018180051638.png)
![](/img/user/assets/images/Knowledge/AI/IMG-20251018180051991.png)

# Method
- ![](/img/user/assets/images/Knowledge/AI/IMG-20251018180052430.png)
- 
# Summary
